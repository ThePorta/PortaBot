...
func TestMarshalUnmarshalSetChatIdRequest(t *testing.T) {
	v := SetChatIdRequest{}
	bts, err := v.MarshalMsg(nil)
	if err != nil {
		t.Fatal(err)
...
func BenchmarkMarshalMsgSetChatIdRequest(b *testing.B) {
	v := SetChatIdRequest{}
	b.ReportAllocs()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
...
func BenchmarkAppendMsgSetChatIdRequest(b *testing.B) {
	v := SetChatIdRequest{}
	bts := make([]byte, 0, v.Msgsize())
	bts, _ = v.MarshalMsg(bts[0:0])
	b.SetBytes(int64(len(bts)))
...
func BenchmarkUnmarshalSetChatIdRequest(b *testing.B) {
	v := SetChatIdRequest{}
	bts, _ := v.MarshalMsg(nil)
	b.ReportAllocs()
	b.SetBytes(int64(len(bts)))
...
func TestEncodeDecodeSetChatIdRequest(t *testing.T) {
	v := SetChatIdRequest{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
	...
	m := v.Msgsize()
	if buf.Len() > m {
		t.Log("WARNING: TestEncodeDecodeSetChatIdRequest Msgsize() is inaccurate")
	}
...
func BenchmarkEncodeSetChatIdRequest(b *testing.B) {
	v := SetChatIdRequest{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
	b.SetBytes(int64(buf.Len()))
...
func BenchmarkDecodeSetChatIdRequest(b *testing.B) {
	v := SetChatIdRequest{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
	b.SetBytes(int64(buf.Len()))
